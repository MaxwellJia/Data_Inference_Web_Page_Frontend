                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                            Please upload the CSV file. The format of each column will be automatically inferred after pressing the button.
                            If you wish to modify a column's format, please select the desired option from the drop-down menu. You can also save the modified file at any time.
                        </p>
